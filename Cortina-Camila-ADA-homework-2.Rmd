...
histogram(simulation, xlim = c(0,40), xlab = "simulated number of calls") #The simulated results are very similar to the plotted distribution above
```
...
se_mean
lower_confidence_interval<- se_mean + qnorm(.025)*sample_sd
lower_confidence_interval
upper_confidence_interval<- se_mean + qnorm(.975)*sample_sd
